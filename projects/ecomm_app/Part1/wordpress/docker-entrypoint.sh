...
define('WP_SITEURL','${WP_HOST}');" >> /var/www/html/wp-config.php

echo "Replacing old host with ${WP_HOST}"
wp --allow-root search-replace http://woodkraft.ntnxsherlock.com ${WP_HOST}
